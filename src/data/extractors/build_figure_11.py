...
import config
from figure11 import build_figure_11_payload
...
def resolve_output_path() -> Path:
    if config.OUTPUT_PATH_FIGURE_11.is_absolute():
        return config.OUTPUT_PATH_FIGURE_11
    return PROJECT_ROOT / config.OUTPUT_PATH_FIGURE_11
...
def main() -> None:
    ...
    try:
        payload = build_figure_11_payload(engine)
